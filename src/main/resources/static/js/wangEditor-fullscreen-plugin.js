...
window.wangEditor.fullscreen = {
    init: function(editor) {
        ...
        $(toolbar).append('<div class="w-e-menu btn_fullscreen" onclick="window.wangEditor.fullscreen.run(\''+id+'\')"><svg class="icon" aria-hidden="true">\n' +
    ...
    run: function(id) {
        ...
        container.find('.btn_fullscreen').add(this.isFullScreen);
    }
};
